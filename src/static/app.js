document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // Reset activity select options so repeated fetches don't duplicate entries
